...
<body>
    ...
    <h5>" Your Prefrence,Our Priority... "</h5>
            ...
            <div class="category-box" id="basic" >
                ...
                <button class="view-details"><a href="basic bookingW.php">View Details</a></button>
            ...
            <div class="category-box" id="standard">
                ...
                <button class="view-details"><a href="standard bookingW.php">View Details</a></button>
            </div>
            ...
            <div class="category-box" id="premium">
                ...
                <button class="view-details"><a href="premium bookingW.php">View Details</a></button>
            </div>
