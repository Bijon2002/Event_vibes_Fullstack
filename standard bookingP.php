...
$cateringOptions = [];
$sql = "SELECT catering_id, name, price FROM catering WHERE catering_id IN ('22','23','24')";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $cateringOptions[] = $row;
...
<head>
    ...
    <title>Standard Booking Confirmation</title>
    <link rel="stylesheet" href="standard booking.css">
</head>
<body>
...
<header>
    <nav>
        ...
        <li class="nav-item"><a href="home.php">Home</a></li>
            <li class="nav-item" id="home-item"><a href="event_list.php">Events</a></li>
...
<main>
    <div class="booking">
        <h1 id="head">Our Standard Plan</h1>
        <h4 id="sub">Booking Summary</h4>

        <form method="POST" >
            <input type="hidden" name="event_name" value="Puberty-Ceremony">
